...
import ListPetugas from "./ListPetugas";
      ...
      <div className="min-h-screen relative flex">
                ...
                <>
                  ...
                  <Transition
                    ...
                    <Disclosure.Panel static className="px-14">
                      <button
                        onClick={() => setBarTitle("list-petugas")}
                        className="py-3 outline-none focus:outline-none hover:text-primary">
                        List User
                      </button>
                      <button
                        onClick={() => setBarTitle("tambah-petugas")}
                        className="py-3 outline-none focus:outline-none hover:text-primary">
                        Tambah User
                      </button>
                      {/* <button
                        onClick={() => setBarTitle("tanggapan-petugas")}
                        className="py-3 outline-none focus:outline-none hover:text-primary">
                        Tanggapan Petugas
                      </button> */}
                    </Disclosure.Panel>
              ...
              {({ open }) => (
                <>
                  ...
                  <Transition
                    ...
                    <Disclosure.Panel static className="px-14">
                      <button
                        onClick={() => setBarTitle("cetak-periode")}
                        className="py-3 outline-none focus:outline-none hover:text-primary">
                        Berdasarkan Periode
                      </button>
                      {/* <button
                        onClick={() => setBarTitle("cetak-daerah")}
                        className="py-3 outline-none focus:outline-none hover:text-primary">
                        Berdasarkan Daerah
                      </button>
                      <button
                        onClick={() => setBarTitle("cetak-jenis")}
                        className="py-3 outline-none focus:outline-none hover:text-primary">
                        Berdasarkan Jenis
                      </button> */}
                    </Disclosure.Panel>
        ...
        <div className="flex-col flex bg-gray-50 w-full">
          ...
          <div className="p-8 pb-20">
            {barTitle === "dashboard" ? (
            ...
            ) : barTitle === "list-petugas" ? (
              <ListPetugas {...props} />
            ) : barTitle === "tambah-petugas" ? (
              <AddPetugas />
            ) : barTitle === "tanggapan-petugas" ? (
              <div>Tanggapan Petugas</div>
              ...
              <DoneComplaint {...props} />
            ) : barTitle === "cetak-periode" ? (
              <PrintDate />
            ) : barTitle === "cetak-daerah" ? (
              <div>Cetak Daerah</div>
            ) : barTitle === "cetak-jenis" ? (
              <div>Cetak Jenis</div>
            ) : null}
          </div>
        </div>
