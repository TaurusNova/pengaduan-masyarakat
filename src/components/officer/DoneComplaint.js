...
const DoneComplaint = (props) => {
  ...
  const getList = () => {
    axios
      .get(
        "/api/officer/completed_complaints",
        {
  ...
  return (
    <div>
      <div>
        ...
        <p className="text-2xl">Laporan yang Selesai</p>
      </div>
      <div>
        {listComplaints === null ? (
          <div>Loading...</div>
                  ...
                  <tr key={index}>
                    ...
                    <td className="space-x-3 text-center">
                      <button
                        ...
                        onClick={() => props.history.push(`/dashboard/complaint/${item.id_pengaduan}`)}>
